                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $product->regular_price}}" name="regular_price" placeholder="Enter regular price" />
                            @error('regular_price')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $product->selling_price }}" name="selling_price" placeholder="Enter selling price" />
                            @error('selling_price')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $product->discount }}" name="discount" placeholder="Enter discount amount" />
                            @error('discount')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" min="1" value="{{ $product->quantity }}" name="quantity" placeholder="Enter product quantity" />
                            @error('quantity')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="short_description" rows="3"  placeholder="Enter product's short description">{{ $product->short_description }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="long_description" rows="5" placeholder="Enter product's long description">{{ $product->long_description }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ $product->main_image }}" height="80" width="140" class="mt-2 rounded-2" alt="" />
                            @error('main_image')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @foreach($product->otherImages as $otherImage)
                                <img src="{{ $otherImage->image }}" height="80" width="100" class="mt-2 rounded-2" alt="" />
                            @endforeach
                            @error('other_images')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <input type="radio" class="form-check-input" id="formrow-for-published" @checked($product->status === 1) checked name="status" value="1" />
                                    <label for="formrow-for-published" class="form-check-label">Publish</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <input type="radio" class="form-check-input" id="formrow-for-unpublished" @checked($product->status === 0) name="status" value="0" />
